...
class DatabaseAnalyzer: 
    ...
    def __init__(self):
        ...
        self.male_std_dev = 0
        self.female_std_dev = 0
        self.unknown_std_dev = 0
    ...
    def identify_gender(self):
        ...
        self.male_std_dev = numpy.std(self.male_list)
        self.female_std_dev = numpy.std(self.female_list)
        self.unknown_std_dev = numpy.std(self.unknown_list)
        ...
        print "Standard deviation: Male: {0}, Female {1}, Unknown {3}".format(self.male_std_dev, self.female_std_dev, self.unknown_std_dev)

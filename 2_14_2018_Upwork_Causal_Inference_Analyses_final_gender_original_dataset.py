...
class UpworkCausalInference:
    ...
    def __init__(self):  
        self.data_analysis_file_name = './csv_files/formatted_analysis_df_2017_12_12_upwork_analysis_unitedstates_allskills.csv'
        self.default_output_file_name = './analyses_output/final_gender_original_dataset_causal_inference_2017_12_12_upwork_analysis_unitedstates_allskills.txt'

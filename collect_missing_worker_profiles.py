...
class MissingProfilesQuerier: 
    def __init__(self):
        self.log = open('json_files/log_upwork_missing_data_collection_2017_10_30_unitedstates_webdev.txt', 'a') # Creating a log
    ...
    def define_missing_profiles(self):
        with open('json_files/log_upwork_data_collection_2017_10_23_unitedstates_webdev.txt') as f:
            for line in f:

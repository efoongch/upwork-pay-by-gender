...
class UpworkQuerier: 
    def __init__(self):
        self.log = open('json_files/log_upwork_data_collection_2017_11_01_unitedstates_allskills.txt', 'a') # Creating a log
    ...
    def on_workers(self, workers):
        for worker in workers:
            ...
            try:
                ...
                self.cur.execute("INSERT INTO upwork_unitedstates_allskills_2017_11_01 (user_id, date_collected, user_name, worker, detailed_info) VALUES (%s, %s, %s, %s, %s);",

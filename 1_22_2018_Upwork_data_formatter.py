...
class UpworkDataFormatter:
    ...
    def __init__(self):
        ...
        self.all_data_file_name = './csv_files/2017_12_12_upwork_analysis_unitedstates_allskills.csv' # Filename for all data
        ...
        try: 
            ...
            if(ed_history == ""):
                ...
                if (ed_history["ed_degree"] == ""):
                    highest_education = self.check_highest_education("None specified")
    ...
    def check_highest_education(self, degree):
        ...
        # Professional degree
        if (re.search('d\.c|d\.c\.m|d\.d\.s|d\.m\.d|ll\.b|ll\.m|l\.l\.m|l\.l\.b|j\.d\.|m\.d\.|o\.d\.|d\.o\.|pharm\.d', degree.lower()) or re.search('d\.p\.m|d\.p|pod\.d|m\.div|m\.h\.l|b\.d|ordination|d\.v\.m| law', degree.lower())):
            return "Professional"
        
        # PhD
        elif (re.search('doctor', degree.lower())): # Doctorate placed here in case MDs are also called doctors 
            return "Doctorate"
        ...
        # High School
            ...
            print "This was ambiguous: {0}".format(degree)

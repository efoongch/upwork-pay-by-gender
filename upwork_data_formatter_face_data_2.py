...
class UpworkDataFormatter:
    ...
    def __init__(self):
        ...
        self.all_data_file_name = './csv_files/trial_2017_12_12_upwork_analysis_unitedstates_allskills.csv' # Filename for all data
        self.face_data_file_name = './csv_files/trial_2017_12_12_upwork_face_data_unitedstates_allskills.csv' # Filename for gender data
        self.data_log_file_name = './log_files/log_upwork_data_analysis_2017_12_12_unitedstates_allskills.txt'
        ...
        self.log.flush()
        self.photo_log.write("We have started saving face data from photos!" + "\n")
    ...
    def save_all_to_csv(self):
        with open(self.all_data_file_name, 'w') as csvfile:
            fieldnames = ['user_count','worker_id', 'first_name', 'bill_rate', 
                          ...
                          'timezone', 'date_last_active', 'jobs_completed', 'has_completed_jobs']
            ...
            for user in self.cur:
                try: 
                    ...
                    has_completed_jobs = 0 # Whether worker has completed any jobs 
                    if (jobs_completed > 0):
                        has_completed_jobs = 1
                    ...
                    writer.writerow({'user_count': self.user_count, 'worker_id': worker_id, 'first_name': first_name,
                                 ...
                                 'education_id': education_id, 'work_experience': work_experience, 'job_category': job_category, 'job_category_id': job_category_id, 
                                    ...
                                    'jobs_completed': jobs_completed, 'has_completed_jobs': has_completed_jobs})
                except:
                    ...
                    writer.writerow({'user_count': self.user_count, 'worker_id': "error", 'first_name': "error",
                                 ...
                                 'education_id': self.error_education_id, 'work_experience': "error", 'job_category': "error", 'job_category_id': self.error_job_category_id, 
                                    ...
                                    'jobs_completed': "error", 'has_completed_jobs': "error"})
